...
export const CertificateModal = ({ imageUrl, title, onClose }: CertificateModalProps) => {
  return (
    ...
    >
      <div
        className="relative m-4 w-full max-w-lg max-h-[90vh] rounded-xl bg-background p-4 shadow-lg shadow-accent/20 animate-[modal-content-show_0.3s_ease-out] lg:max-w-4xl"
